...
export const calorieGoalValidator = object({
  ...
  carbs: number().openapi({description: 'Carbs of the calorie goal'}),
  protein: number().openapi({description: 'Protein of the calorie goal'}),
  fat: number().openapi({description: 'Fat of the calorie goal'}),
