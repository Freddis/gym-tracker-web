...
> {
  ...
  public readonly factory: OpenApiRoutingFactory<TRouteTypes, TSpec>;
  ...
  constructor(a: TRouteTypes, b: TErrorCodes, spec: TSpec) {
    ...
    this.factory = new OpenApiRoutingFactory<TRouteTypes, TSpec>(spec);
  }
