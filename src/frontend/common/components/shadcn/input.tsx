  ...
  return (
    <input
      ...
      className={cn(
        ...
        selection:text-primary-foreground dark:bg-input/30 border-input flex h-10 w-full min-w-0 
        rounded-sm border bg-red px-3 py-1 text-base shadow-xs transition-[color,box-shadow] 
