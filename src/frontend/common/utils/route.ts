...
const baseRouteMap = createRouteMap({
  ...
  '/entries/$id': RouteId.EntryView,
  '/entries/add': RouteId.EntryAdd,
  '/exercises': RouteId.ExerciseList,
  '/exercises/built-in': RouteId.ExerciseLibrary,
  ...
  '/posts/create': RouteId.PostCreate,
  '/posts/update/$id': RouteId.PostUpdate,
  '/meals/create': RouteId.MealCreate,
  '/meals/update/$id': RouteId.MealUpdate,
  '/goals/calorie/create': RouteId.CalorieGoalCreate,
  ...
  '/food': RouteId.FoodList,
  '/food/built-in': RouteId.FoodLibrary,
  '/food/create': RouteId.FoodCreate,
  '/food/create-meal': RouteId.FoodCreateMeal,
  '/food/update/$id': RouteId.FoodUpdate,
  '/profile': RouteId.Profile,
  '/settings': RouteId.Settings,
  '/settings/edit': RouteId.SettingsUpdate,
  '/settings/change-password': RouteId.PasswordChange,
  '/crm': RouteId.Crm,
  ...
  '/stoplight': RouteId.Stoplight,
  '/api-schema': RouteId.ApiSchema,
});
