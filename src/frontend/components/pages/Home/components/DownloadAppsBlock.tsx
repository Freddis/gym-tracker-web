      ...
      <div className="w-xl max-w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-center">
          <div className="flex justify-center">
            <img className="w-63 object-contain" src="/images/pages/home/google-play-download-link.png" />
          </div>
          <div className="flex justify-center">
            <img className="w-50 py-5 object-contain" src="/images/pages/home/appstore-download-link.svg" />
          </div>
        </div>
      </div>
    </div>
