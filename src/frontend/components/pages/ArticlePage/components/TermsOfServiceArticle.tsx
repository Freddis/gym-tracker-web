...
export const TermsOfServiceArticle: FC = () => {
  return (
    <AppBlock>
      <AppBlockHeader>Terms and Conditions</AppBlockHeader>
      <p>Last updated: August 02, 2025</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Home Studio, Ozaani vlg 1.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Discipline, accessible from{' '}
            <a
              href="https://discipline.alex-sarychev.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://discipline.alex-sarychev.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@discipline.alex-sarychev.com</li>
      </ul>
    </AppBlock>
  );
};
